...
const ContactStyle = styled.div`
    ...
    border-radius: 12px;
    border: 1px solid ${(props) => props.theme.headerPrimary}20;
...
export default function ContactItem(props) {
    ...
    return (
        <ContactStyle theme={theme}>
            <ContactIcon theme={theme} href={props.title === "Github" ? "https://github.com/klanting" : "https://www.linkedin.com/in/tibo-verreycken-459243283"}
               target="_blank" rel="noopener noreferrer" style={{color: 'inherit', textDecoration: 'none'}}>
                {props.title === "Github" ? getGithub() : getLinkedIn()}
            </ContactIcon>
        </ContactStyle>
    )
}